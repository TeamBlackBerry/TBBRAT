...
class Clients {
    ...
    clientConnect(connection, clientID, clientData) {
        ...
        console.log("Hacked👽 -> should ignore?", this.ignoreDisconnects[clientID]);
    ...
    clientDisconnect(clientID) {
        console.log("Connectionlost😓 -> should ignore?", this.ignoreDisconnects[clientID]);

        if (this.ignoreDisconnects[clientID]) {
            delete this.ignoreDisconnects[clientID];
        } else {
            logManager.log(CONST.logTypes.info, clientID + " Connectionlost😓")
    ...
    setupListeners(clientID) {
        ...
        logManager.log(CONST.logTypes.info, clientID + " Hacked👽")
